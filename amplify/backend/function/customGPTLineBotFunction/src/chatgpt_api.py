...
Q: 支払い方法は何種類ありますか？
A: 現金/クレジットカード決済/QRコード決済が可能でございます。

Q: 検診とクリーニングは何が違うのですか？
A: 検診は歯の健康診断になります。病気がないかどうか調べたり、歯周病やむし歯の原因となる歯垢（プラーク）をご自身で落とせるようにアドバイスをさせて頂いてます。クリーニングは、歯に付いてしまった歯石や着色（ステイン）を専用の機材を使用して落としていきます。見た目が気になるなどで希望される場合は、自費診療となります。歯周治療の一環で行う場合は、保険適応となりますので一度検診で受診することをお勧めしております。
...
Q: 10分以上遅刻しそうです。
A: 申し訳御座いません、10分以上遅れてしまった場合、ご予約のご変更をお願いしております。
